...
df = pd.read_excel(file_path, sheet_name='Non-Tech(Team4)').fillna("N/A")
...
<body>
    <div class="container">
        ...
        <p>Thank you for registering your team  for the <span class="highlight">{details['Preferred Non-Technical Events']}</span> event!</p>
        <p><strong>Team Details:</strong></p>
        <ul>
            <li><strong>Event Type:</strong> Non-Technical (4-members)</li>
...
for index, row in df.iterrows():
    ...
    if pd.notna(email):
        qr_data = f"""
        Event Type: Non-Technical (4-members)
