...
df = pd.read_excel(file_path, sheet_name='idea').fillna("N/A")
...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li><strong>Event Type:</strong> Idea Elevator Pitching Contest </li>
...
for index, row in df.iterrows():
    ...
    if pd.notna(email):
        ...
        Event Type: Idea Elevator Pitching Contest
        College Name: {row['College Name']}
        Department: {row['Department ( Eg: B.Tech (AI&DS)']}
