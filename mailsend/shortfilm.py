...
df = pd.read_excel(file_path, sheet_name='Flick Fest(Short Film)').fillna("N/A")
...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li><strong>Event Type:</strong> Flick Fest(Short Film)</li>
