...
df = pd.read_excel(file_path, sheet_name='Hackathon').fillna("N/A")
...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li><strong>Event Type:</strong> Hackathon </li>
...
for index, row in df.iterrows():
    ...
    if pd.notna(email):
        ...
        Team Lead: {row['Team Lead Name (e.g: Ruban B)']} ({row['Team Lead Mail ID']})
        ...
        details = {
    'Team Name': row['Team Name'],
    'Team Lead Name': row['Team Lead Name (e.g: Ruban B)'],
